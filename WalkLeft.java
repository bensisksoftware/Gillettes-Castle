	...
	public static void walk() {
		switch (Player.getPosition()) {
			...
			case "entry_2n":
				...
				break;
			case "entry_2w":
				Player.setPosition("entry_2s");
				break;	
			case "entry_2s":
				Player.setPosition("entry_2e");
				break;	
			case "entry_2e":
			...
			case "entry_3w":
				...
				break;	
			case "entry_3s":
				Player.setPosition("entry_3e");
				break;	
			case "entry_3e":
				Player.setPosition("entry_3n");
				break;
			case "entry_4n":
			...
			case "entry_4s":
				...
				break;	
			case "entry_4e":
				Player.setPosition("entry_4n");
				break;
			case "entry_5n":
				Player.setPosition("entry_5w");
				break;
			case "entry_5w":
			...
			case "entry_5s":
				...
				break;	
			case "entry_5e":
				Player.setPosition("entry_5n");
				break;
			case "entry_6n":
				Player.setPosition("entry_6w");
				break;
			case "entry_6w":
				Player.setPosition("entry_6s");
				break;	
			case "entry_6s":
			...
			case "entry_6e":
				...
				break;
			case "entry_7n":
				Player.setPosition("entry_7w");
				break;
			case "entry_7w":
				Player.setPosition("entry_7s");
				break;	
			case "entry_7s":
			...
			case "entry_8s":
				...
				break;	
			case "entry_8e":
				Player.setPosition("entry_8n");
				break;
			case "entry_9n":
				Player.setPosition("entry_9w");
				break;
			case "entry_9w":
				Player.setPosition("entry_9s");
				break;	
			case "entry_9s":
			...
			case "entry_10n":
				...
				break;
			case "entry_10w":
				Player.setPosition("entry_10s");
				break;
			case "entry_10s":
				Player.setPosition("entry_10e");
				break;
			case "entry_10e":
				Player.setPosition("entry_10n");
				break;

			case "hall_1n":
				Player.setPosition("hall_1w");
				break;
			case "hall_1w":
				Player.setPosition("hall_1s");
				break;
			case "hall_1s":
				Player.setPosition("hall_1e");
				break;
			case "hall_1e":
				Player.setPosition("hall_1n");
				break;
			case "hall_2n":
				Player.setPosition("hall_2w");
				break;
			case "hall_2w":
			...
			case "hall_3n":
				...
				break;
			case "hall_3w":
				Player.setPosition("hall_3s");
				break;
			case "hall_3s":
				Player.setPosition("hall_3e");
				break;
			case "hall_3e":
				Player.setPosition("hall_3n");
				break;
			case "hall_4n":
			...
			case "hall_8n":
				...
				break;
			case "hall_8w":
				Player.setPosition("hall_8s");
				break;
			case "hall_8s":
				Player.setPosition("hall_8e");
				break;
			case "hall_8e":
				Player.setPosition("hall_8n");
				break;
			case "hall_9n":
				Player.setPosition("hall_9w");
				break;
			case "hall_9w":
				Player.setPosition("hall_9s");
				break;
			case "hall_9s":
				Player.setPosition("hall_9se");
				break;
			case "hall_9s_close":
				Player.setPosition("hall_9s");
				break;
			case "hall_9se":
				Player.setPosition("hall_9e");
				break;
			case "hall_9e":
				Player.setPosition("hall_9n");
				break;
			case "hall_10n":
				Player.setPosition("hall_10nw");
				break;
			case "hall_10nw":
				Player.setPosition("hall_10w");
				break;
			case "hall_10w":
			...
			case "hall_10e":
				...
				break;
			case "hall_11n":
				Player.setPosition("hall_11nw");
				break;
			case "hall_11nw":
				Player.setPosition("hall_11w");
				break;
			case "hall_11w":
				Player.setPosition("hall_11sw");
				break;
			case "hall_11s":
			...
			case "hall_11sw":
				...
				break;
			case "hall_11e":
				Player.setPosition("hall_11n");
				break;
			case "hall_12n":
				Player.setPosition("hall_12w");
				break;
			case "hall_12w":
			...
			case "green_1w":
				...
				break;
			case "green_1s":
				Player.setPosition("green_1e");
				break;
			case "green_1e":
				Player.setPosition("green_1n");
				break;
			case "green_2n":
				Player.setPosition("green_2w");
				break;
			case "green_2w":
			...
			case "green_2s":
				...
				break;
			case "green_2e":
				Player.setPosition("green_2n");
				break;
			case "wing_1n":
				Player.setPosition("wing_1w");
				break;
			case "wing_1w":
				Player.setPosition("wing_1s");
				break;
			case "wing_1s":
				Player.setPosition("wing_1e");
				break;
			case "wing_1e":
			...
			case "wing_2w":
				...
				break;
			case "wing_2s":
				Player.setPosition("wing_2e");
				break;
			case "wing_2e":
				Player.setPosition("wing_2n");
				break;
			case "wing_3n":
				Player.setPosition("wing_3w");
				break;
			case "wing_3w":
				Player.setPosition("wing_3s");
				break;
			case "wing_3s":
				Player.setPosition("wing_3e");
				break;
			case "wing_3e":
				Player.setPosition("wing_3n");
				break;
			case "wing_4n":
				Player.setPosition("wing_4w");
				break;
			case "wing_4w":
			...
			case "wing_4e":
				...
				break;
			case "wing_5n":
				Player.setPosition("wing_5w");
				break;
			case "wing_5w":
				Player.setPosition("wing_5s");
				break;
			case "wing_5s":
				Player.setPosition("wing_5e");
				break;
			case "wing_5e":
				Player.setPosition("wing_5n");
				break;
			 case "wing_6n":
				Player.setPosition("wing_6w");
				break;
			case "wing_6w":
				Player.setPosition("wing_6s");
				break;
			case "wing_6s":
				Player.setPosition("wing_6e");
				break;
			case "wing_6e":
				Player.setPosition("wing_6n");
				break;
			case "wing_7n":
				Player.setPosition("wing_7w");
				break;
			case "wing_7w":
				Player.setPosition("wing_7s");
				break;
			case "wing_7s":
				Player.setPosition("wing_7e");
				break;
			case "wing_7e":
			...
			case "nook_1n":
				...
				break;
			case "nook_1w":
				Player.setPosition("nook_1s");
				break;
			case "nook_1s":
				Player.setPosition("nook_1e");
				break;
			case "nook_1e":
				Player.setPosition("nook_1n");
				break;
			case "nook_2n":
				Player.setPosition("nook_2w");
				break;
			case "nook_2w":
				Player.setPosition("nook_2s");
				break;
			case "nook_2s":
				Player.setPosition("nook_2e");
				break;
			case "nook_2e":
				Player.setPosition("nook_2n");
				break;
			case "nook_3n":
				Player.setPosition("nook_3w");
				break;
			case "nook_3w":
				Player.setPosition("nook_3s");
				break;
			case "nook_3s":
				Player.setPosition("nook_3e");
				break;
			case "nook_3e":
				Player.setPosition("nook_3n");
				break;
			case "nook_4n":
				Player.setPosition("nook_4w");
				break;
			case "nook_4w":
				Player.setPosition("nook_4s");
				break;
			case "nook_4s":
				Player.setPosition("nook_4e");
				break;
			case "nook_4e":
				Player.setPosition("nook_4n");
				break;
			case "nook_5n":
				Player.setPosition("nook_5w");
				break;
			case "nook_5w":
				Player.setPosition("nook_5s");
				break;
			case "nook_5s":
				Player.setPosition("nook_5e");
				break;
			case "nook_5e":
				Player.setPosition("nook_5n");
				break;
						case "bed_1n":
				Player.setPosition("bed_1w");
				break;
			case "bed_1w":
				Player.setPosition("bed_1s");
				break;
			case "bed_1s":
				Player.setPosition("bed_1e");
				break;
			case "bed_1e":
				Player.setPosition("bed_1n");
				break;
			case "bed_2n":
				Player.setPosition("bed_2w");
				break;
			case "bed_2w":
				Player.setPosition("bed_2s");
				break;
			case "bed_2s":
				Player.setPosition("bed_2e");
				break;
			case "bed_2e":
				Player.setPosition("bed_2n");
				break;
			case "bed_3n":
				Player.setPosition("bed_3w");
				break;
			case "bed_3w":
				Player.setPosition("bed_3s");
				break;
			case "bed_3s":
			...
			case "bed_4w":
				...
				break;
			case "bed_4s":
				Player.setPosition("bed_4e");
				break;
			case "bed_4e":
				Player.setPosition("bed_4n");
				break;
			case "bed_5n":
				Player.setPosition("bed_5w");
				break;
			case "bed_5w":
			...
			case "bed_6w":
				...
				break;
			case "bed_6s":
				Player.setPosition("bed_6e");
				break;
			case "bed_6e":
				Player.setPosition("bed_6n");
				break;
			case "bed_7n":
				Player.setPosition("bed_7w");
				break;
			case "bed_7w":
			...
			case "bed_7s":
				...
				break;
			case "bed_7e":
				Player.setPosition("bed_7n");
				break;
			case "bed_8n":
				Player.setPosition("bed_8w");
				break;
			case "bed_8w":
				Player.setPosition("bed_8s");
				break;
			case "bed_8s":
				Player.setPosition("bed_8e");
				break;
			case "bed_8e":
				Player.setPosition("bed_8n");
				break;
			case "bed_9n":
				Player.setPosition("bed_9w");
				break;
			case "bed_9w":
				Player.setPosition("bed_9s");
				break;
			case "bed_9s":
				Player.setPosition("bed_9e");
				break;
			case "bed_9e":
			...
			case "bed_10w":
				...
				break;
			case "bed_10s":
				Player.setPosition("bed_10e");
				break;
			case "bed_10e":
				Player.setPosition("bed_10n");
				break;
			case "bed_11n":
				Player.setPosition("bed_11w");
				break;
			case "bed_11w":
				Player.setPosition("bed_11s");
				break;
			case "bed_11s":
				Player.setPosition("bed_11e");
				break;
			case "bed_11e":
				Player.setPosition("bed_11n");
				break;
			case "bed_12n":
				Player.setPosition("bed_12w");
				break;
			case "bed_12w":
				Player.setPosition("bed_12s");
				break;
			case "bed_12s":
				Player.setPosition("bed_12e");
				break;
			case "bed_12e":
				Player.setPosition("bed_12n");
				break;
			case "bed_13n":
				Player.setPosition("bed_13w");
				break;
			case "bed_13w":
				Player.setPosition("bed_13s");
				break;
			case "bed_13s":
				Player.setPosition("bed_13e");
				break;
			case "bed_13e":
				Player.setPosition("bed_13n");
				break;
			case "bed_14n":
				Player.setPosition("bed_14w");
				break;
			case "bed_14w":
				Player.setPosition("bed_14s");
				break;
			case "bed_14s":
			...
			case "bed_14sw":
				...
				break;
			case "bed_14e":
				Player.setPosition("bed_14ne");
				break;
			case "bed_15n":
				Player.setPosition("bed_15w");
				break;
			case "bed_15w":
				Player.setPosition("bed_15sw");
				break;
			case "bed_15s":
			...
			case "bed_15sw":
				...
				break;
			case "bed_15e":
				Player.setPosition("bed_15n");
				break;
			case "bed_16n":
				Player.setPosition("bed_16w");
				break;
			case "bed_16w":
				Player.setPosition("bed_16s");
				break;
			case "bed_16s":
				Player.setPosition("bed_16e");
				break;
			case "bed_16e":
			...
			case "bed_17n":
				...
				break;
			case "bed_17w":
				Player.setPosition("bed_17s");
				break;
			case "bed_17s":
				Player.setPosition("bed_17e");
				break;
			case "bed_17e":
				Player.setPosition("bed_17n");
				break;
			case "bed_18n":
			...
			case "bed_18s":
				...
				break;
			case "bed_18e":
				Player.setPosition("bed_18n");
				break;
			case "bed_19n":
				Player.setPosition("bed_19w");
				break;
			case "bed_19w":
				Player.setPosition("bed_19s");
				break;
			case "bed_19s":
				Player.setPosition("bed_19e");
				break;
			case "bed_19e":
				Player.setPosition("bed_19n");
				break;
			case "bed_20n":
				Player.setPosition("bed_20w");
				break;
			case "bed_20w":
				Player.setPosition("bed_20s");
				break;
			case "bed_20s":
				Player.setPosition("bed_20e");
				break;
			case "bed_20e":
				Player.setPosition("bed_20n");
				break;
			case "bed_21n":
				Player.setPosition("bed_21w");
				break;
			case "bed_21w":
				Player.setPosition("bed_21s");
				break;
			case "bed_21s":
				Player.setPosition("bed_21e");
				break;
			case "bed_21e":
				Player.setPosition("bed_21n");
				break;
			case "climb_1n":
				Player.setPosition("climb_1w");
				break;
			case "climb_1w":
				Player.setPosition("climb_1s");
				break;
			case "climb_1s":
				Player.setPosition("climb_1e");
				break;
			case "climb_1e":
				Player.setPosition("climb_1n");
				break;
			case "climb_2n":
				Player.setPosition("climb_2w");
				break;
			case "climb_2w":
				Player.setPosition("climb_2s");
				break;
			case "climb_2s":
				Player.setPosition("climb_2e");
				break;
			case "climb_2e":
				Player.setPosition("climb_2n");
				break;
			case "climb_3n":
				Player.setPosition("climb_3w");
				break;
			case "climb_3w":
				Player.setPosition("climb_3s");
				break;
			case "climb_3s":
				Player.setPosition("climb_3e");
				break;
			case "climb_3e":
				Player.setPosition("climb_3n");
				break;
			case "climb_4n":
				Player.setPosition("climb_4w");
				break;
			case "climb_4w":
				Player.setPosition("climb_4s");
				break;
			case "climb_4s":
				Player.setPosition("climb_4e");
				break;
			case "climb_4e":
				Player.setPosition("climb_4n");
				break;
			case "climb_5n":
				Player.setPosition("climb_5w");
				break;
			case "climb_5w":
				Player.setPosition("climb_5s");
				break;
			case "climb_5s":
				Player.setPosition("climb_5e");
				break;
			case "climb_5e":
				Player.setPosition("climb_5n");
				break;
			case "climb_6n":
				Player.setPosition("climb_6w");
				break;
			case "climb_6w":
				Player.setPosition("climb_6s");
				break;
			case "climb_6s":
				Player.setPosition("climb_6e");
				break;
			case "climb_6e":
			...
			case "gallery_2n":
				...
				break;
			case "gallery_2w":
				Player.setPosition("gallery_2s");
				break;
			case "gallery_2s":
				Player.setPosition("gallery_2e");
				break;
			case "gallery_2e":
				Player.setPosition("gallery_2n");
				break;
			case "gallery_3n":
				Player.setPosition("gallery_3w");
				break;
			case "gallery_3w":
				Player.setPosition("gallery_3s");
				break;
			case "gallery_3s":
			...
			case "gallery_4s":
				...
				break;
			case "gallery_4e":
				Player.setPosition("gallery_4n");
				break;
			case "gallery_5n":
				Player.setPosition("gallery_5w");
				break;
			case "gallery_5w":
				Player.setPosition("gallery_5s");
				break;
			case "gallery_5s":
				Player.setPosition("gallery_5e");
				break;
			case "gallery_5e":
				Player.setPosition("gallery_5n");
				break;
			case "gallery_6n":
			...
			case "gallery_8n":
				...
				break;
			case "gallery_8w":
				Player.setPosition("gallery_8s");
				break;
			case "gallery_8s":
				Player.setPosition("gallery_8e");
				break;
			case "gallery_8e":
				Player.setPosition("gallery_8n");
				break;
			case "gallery_9n":
				Player.setPosition("gallery_9w");
				break;
			case "gallery_9w":
				Player.setPosition("gallery_9s");
				break;
			case "gallery_9s":
			...
			case "gallery_9e":
				...
				break;
			case "gallery_10n":
				Player.setPosition("gallery_10w");
				break;
			case "gallery_10w":
			...
			case "gallery_10s":
				...
				break;
			case "gallery_10e":
				Player.setPosition("gallery_10n");
				break;
			case "gallery_11n":
				Player.setPosition("gallery_11w");
				break;
			case "gallery_11w":
				Player.setPosition("gallery_11s");
				break;
			case "gallery_11s":
				Player.setPosition("gallery_11e");
				break;
			case "gallery_11e":
				Player.setPosition("gallery_11n");
				break;
			case "gallery_12n":
			...
			case "gallery_12w":
				...
				break;
			case "gallery_12s":
				Player.setPosition("gallery_12e");
				break;
			case "gallery_12e":
				Player.setPosition("gallery_12n");
				break;
						case "fam_1n":
			...
			case "fam_1s":
				...
				break;
			case "fam_1e":
				Player.setPosition("fam_1n");
				break;
			case "fam_2n":
				Player.setPosition("fam_2w");
				break;
			case "fam_2w":
				Player.setPosition("fam_2s");
				break;
			case "fam_2s":
				Player.setPosition("fam_2e");
				break;
			case "fam_2e":
				Player.setPosition("fam_2n");
				break;
			case "fam_3n":
				Player.setPosition("fam_3w");
				break;
			case "fam_3w":
				Player.setPosition("fam_3s");
				break;
			case "fam_3s":
				Player.setPosition("fam_3e");
				break;
			case "fam_3e":
				Player.setPosition("fam_3n");
				break;
			case "fam_4n":
				Player.setPosition("fam_4w");
				break;
			case "fam_4w":
				Player.setPosition("fam_4s");
				break;
			case "fam_4s":
				Player.setPosition("fam_4e");
				break;
			case "fam_4e":
				Player.setPosition("fam_4n");
				break;
			case "fam_5n":
				Player.setPosition("fam_5w");
				break;
			case "fam_5w":
				Player.setPosition("fam_5s");
				break;
			case "fam_5s":
				Player.setPosition("fam_5e");
				break;
			case "fam_5e":
				Player.setPosition("fam_5n");
				break;
			case "fam_6n":
				Player.setPosition("fam_6w");
				break;
			case "fam_6w":
				Player.setPosition("fam_6s");
				break;
			case "fam_6s":
			...
			case "fam_7s":
				...
				break;
			case "fam_7e":
				Player.setPosition("fam_7n");
				break;
			case "fam_8n":
				Player.setPosition("fam_8w");
				break;
			case "fam_8w":
				Player.setPosition("fam_8s");
				break;
			case "fam_8s":
				Player.setPosition("fam_8e");
				break;
			case "fam_8e":
				Player.setPosition("fam_8n");
				break;
			case "fam_9n":
			...
			case "fam_9w":
				...
				break;
			case "fam_9s":
				Player.setPosition("fam_9e");
				break;
			case "fam_9e":
				Player.setPosition("fam_9n");
				break;
			case "fam_10n":
				Player.setPosition("fam_10w");
				break;
			case "fam_10w":
				Player.setPosition("fam_10s");
				break;
			case "fam_10s":
				Player.setPosition("fam_10e");
				break;
			case "fam_10e":
			...
			case "fam_11n":
				...
				break;
			case "fam_11w":
				Player.setPosition("fam_11s");
				break;
			case "fam_11s":
				Player.setPosition("fam_11e");
				break;
			case "fam_11e":
				Player.setPosition("fam_11n");
				break;
			case "fam_12n":
				Player.setPosition("fam_12w");
				break;
			case "fam_12w":
				Player.setPosition("fam_12s");
				break;
			case "fam_12s":
			...
			case "fam_12e":
				...
				break;
			case "stair_1w":
				Player.setPosition("stair_1s");
				break;
			case "stair_1s":
				Player.setPosition("stair_1e");
				break;
			case "stair_1e":
				Player.setPosition("stair_1n");
				break;
			case "stair_2n":
				Player.setPosition("stair_2w");
				break;
			case "stair_2w":
				Player.setPosition("stair_2s");
				break;
			case "stair_2s":
			...
			case "stair_4w":
				...
				break;
			case "stair_4s":
				Player.setPosition("stair_4e");
				break;
			case "stair_4e":
				Player.setPosition("stair_4n");
				break;
			case "stair_5n":
				Player.setPosition("stair_5w");
				break;
			case "stair_5w":
				Player.setPosition("stair_5s");
				break;
			case "stair_5s":
				Player.setPosition("stair_5e");
				break;
			case "stair_5e":
				Player.setPosition("stair_5n");
				break;
			case "stair_6n":
				Player.setPosition("stair_6w");
				break;
			case "stair_6w":
				Player.setPosition("stair_6s");
				break;
			case "stair_6s":
			...
			case "stair_8w":
				...
				break;
			case "stair_8s":
				Player.setPosition("stair_8e");
				break;
			case "stair_8e":
				Player.setPosition("stair_8n");
				break;
			case "stair_9n":
				Player.setPosition("stair_9w");
				break;
			case "stair_9w":
				Player.setPosition("stair_9s");
				break;
			case "stair_9s":
				Player.setPosition("stair_9e");
				break;
			case "stair_9e":
			...
			case "ground_1n":
				Player.setPosition("ground_1w");
				break;
			case "ground_1w":
				Player.setPosition("ground_1s");
				break;
			case "ground_1s":
				Player.setPosition("ground_1e");
				break;
			case "ground_1e":
				Player.setPosition("ground_1n");
				break;
			case "ground_2n":
				Player.setPosition("ground_2w");
				break;
			case "ground_2w":
			...
			case "ground_3n":
				...
				break;
			case "ground_3w":
				Player.setPosition("ground_3s");
				break;
			case "ground_3w_window":
				Player.setPosition("ground_3w");
				break;
			case "ground_3s":
				Player.setPosition("ground_3e");
				break;
			case "ground_3e":
			...
			case "ground_5s":
				...
				break;
			case "ground_5e":
				Player.setPosition("ground_5n");
				break;
			case "ground_6n":
				Player.setPosition("ground_6w");
				break;
			case "ground_6w":
				Player.setPosition("ground_6s");
				break;
			case "ground_6s":
				Player.setPosition("ground_6e");
				break;
			case "ground_6e":
				Player.setPosition("ground_6n");
				break;
			case "ground_7n":
				Player.setPosition("ground_7w");
				break;
			case "ground_7w":
				Player.setPosition("ground_7s");
				break;
			case "ground_7s":
				Player.setPosition("ground_7e");
				break;
			case "ground_7e":
				Player.setPosition("ground_7n");
				break;
			case "ground_8n":
				Player.setPosition("ground_8w");
				break;
			case "ground_8w":
			...
			case "ground_11w":
				...
				break;
			case "ground_11s":
				Player.setPosition("ground_11e");
				break;
			case "ground_11e":
				Player.setPosition("ground_11n");
				break;
			case "ground_12n":
			...
			case "ground_12bn":
				...
				break;
			case "ground_12bw":
				Player.setPosition("ground_12bs");
				break;
			case "ground_12bs":
				Player.setPosition("ground_12be");
				break;
			case "ground_12be":
			...
			case "ground_13e":
				...
				break;
			case "ground_14n":
				Player.setPosition("ground_14w");
				break;
			case "ground_14n_window":
				Player.setPosition("ground_14n");
				break;
			case "ground_14w":
				Player.setPosition("ground_14s");
				break;
			case "ground_14s":
			...
			case "ground_14e_window":
				...
				break;
			case "ground_15n":
				Player.setPosition("ground_15w");
				break;
			case "ground_15w":
				Player.setPosition("ground_15s");
				break;
			case "ground_15s":
				Player.setPosition("ground_15e");
				break;
			case "ground_15e":
			...
			case "ground_15e_window":
				...
				break;
			case "ground_16n":
				Player.setPosition("ground_16w");
				break;
			case "ground_16w":
				Player.setPosition("ground_16s");
				break;
			case "ground_16s":
				Player.setPosition("ground_16e");
				break;
			case "ground_16e":
				Player.setPosition("ground_16n");
				break;
			case "ground_17n":
				Player.setPosition("ground_17w");
				break;
			case "ground_17w":
				Player.setPosition("ground_17s");
				break;
			case "ground_17s":
				Player.setPosition("ground_17e");
				break;
			case "ground_17e":
			...
			case "ground_18s":
				...
				break;
			case "ground_18e":
				Player.setPosition("ground_18n");
				break;
			case "ground_19n":
				Player.setPosition("ground_19w");
				break;
			case "ground_19w":
				Player.setPosition("ground_19s");
				break;
			case "ground_19s":
				Player.setPosition("ground_19e");
				break;
			case "ground_19e":
				Player.setPosition("ground_19n");
				break;
			case "ground_20n":
				Player.setPosition("ground_20w");
				break;
			case "ground_20w":
				Player.setPosition("ground_20s");
				break;
			case "ground_20s":
				Player.setPosition("ground_20e");
				break;
			case "ground_20e":
				Player.setPosition("ground_20n");
				break;
			case "ground_21n":
				Player.setPosition("ground_21w");
				break;
			case "ground_21w":
			...
			case "ground_23w":
				...
				break;
			case "ground_23s":
				Player.setPosition("ground_23e");
				break;
			case "ground_23e":
				Player.setPosition("ground_23n");
				break;
			case "ground_24n":
				Player.setPosition("ground_24w");
				break;
			case "ground_24w":
				Player.setPosition("ground_24s");
				break;
			case "ground_24s":
			...
			case "ground_25w":
				...
				break;
			case "ground_25s":
				Player.setPosition("ground_25e");
				break;
			case "ground_25e":
				Player.setPosition("ground_25n");
				break;
			case "ground_26n":
				Player.setPosition("ground_26w");
				break;
			case "ground_26w":
				Player.setPosition("ground_26s");
				break;
			case "ground_26s":
				Player.setPosition("ground_26e");
				break;
			case "ground_26e":
				Player.setPosition("ground_26n");
				break;
			case "ground_27n":
				Player.setPosition("ground_27w");
				break;
			case "ground_27w":
				Player.setPosition("ground_27s");
				break;
			case "ground_27s":
				Player.setPosition("ground_27e");
				break;
			case "ground_27e":
				Player.setPosition("ground_27n");
				break;
			case "ground_28n":
				Player.setPosition("ground_28w");
				break;
			case "ground_28w":
				Player.setPosition("ground_28s");
				break;
			case "ground_28s":
				Player.setPosition("ground_28e");
				break;
			case "ground_28e":
				Player.setPosition("ground_28n");
				break;
			case "ground_29n":
				Player.setPosition("ground_29w");
				break;
			case "ground_29w":
				Player.setPosition("ground_29s");
				break;
			case "ground_29s":
				Player.setPosition("ground_29e");
				break;
			case "ground_29e":
			...
			case "ground_30w":
				...
				break;
			case "ground_30s":
				Player.setPosition("ground_30e");
				break;
			case "ground_30e":
				Player.setPosition("ground_30n");
				break;
			case "ground_31n":
				Player.setPosition("ground_31w");
				break;
			case "ground_31w":
			...
			case "ground_31s":
				...
				break;
			case "ground_31e":
				Player.setPosition("ground_31n");
				break;
			case "ground_32n":
				Player.setPosition("ground_32w");
				break;
			case "ground_32w":
				Player.setPosition("ground_32s");
				break;
			case "ground_32s":
				Player.setPosition("ground_32e");
				break;
			case "ground_32e":
				Player.setPosition("ground_32n");
				break;
			case "ground_33n":
				Player.setPosition("ground_33w");
				break;
			case "ground_33w":
				Player.setPosition("ground_33s");
				break;
			case "ground_33s":
				Player.setPosition("ground_33e");
				break;
			case "ground_33e":
				Player.setPosition("ground_33n");
				break;
			case "ground_34n":
				Player.setPosition("ground_34w");
				break;
			case "ground_34w":
				Player.setPosition("ground_34s");
				break;
			case "ground_34s":
				Player.setPosition("ground_34e");
				break;
			case "ground_34e":
				Player.setPosition("ground_34n");
				break;
			case "ground_35n":
				Player.setPosition("ground_35w");
				break;
			case "ground_35w":
			...
			case "ground_35s":
				...
				break;
			case "ground_35e":
				Player.setPosition("ground_35n");
				break;
			case "ground_36n":
				Player.setPosition("ground_36w");
				break;
			case "ground_36w":
				Player.setPosition("ground_36s");
				break;
			case "ground_36s":
				Player.setPosition("ground_36e");
				break;
			case "ground_36e":
				Player.setPosition("ground_36n");
				break;
			case "ground_37n":
				Player.setPosition("ground_37w");
				break;
			case "ground_37w":
				Player.setPosition("ground_37s");
				break;
			case "ground_37s":
			...
			case "ground_37bn":
				...
				break;
			case "ground_37bw":
				Player.setPosition("ground_37bs");
				break;
			case "ground_37bs":
				Player.setPosition("ground_37be");
				break;
			case "ground_37be":
				Player.setPosition("ground_37bn");
				break;
			case "ground_38n":
				Player.setPosition("ground_38w");
				break;
			case "ground_38w":
				Player.setPosition("ground_38s");
				break;
			case "ground_38s":
				Player.setPosition("ground_38e");
				break;
			case "ground_38e":
				Player.setPosition("ground_38n");
				break;
			case "ground_39n":
			...
			case "ground_41n":
				...
				break;
			case "ground_41w":
				Player.setPosition("ground_41s");
				break;
			case "ground_41s":
				Player.setPosition("ground_41e");
				break;
			case "ground_41e":
				Player.setPosition("ground_41n");
				break;
			case "ground_42n":
			...
			case "ground_42w":
				...
				break;
			case "ground_42s":
				Player.setPosition("ground_42e");
				break;
			case "ground_42e":
				Player.setPosition("ground_42n");
				break;
			case "ground_43n":
			...
			case "ground_43w_window":
				...
				break;
			case "ground_43s":
				Player.setPosition("ground_43e");
				break;
			case "ground_43e":
				Player.setPosition("ground_43n");
				break;
			case "ground_44n":
				Player.setPosition("ground_44w");
				break;
			case "ground_44w":
			...
			case "ground_47s":
				...
				break;
			case "ground_47e":
				Player.setPosition("ground_47n");
				break;
			case "ground_48n":
				Player.setPosition("ground_48w");
				break;
			case "ground_48w":
				Player.setPosition("ground_48s");
				break;
			case "ground_48s":
			...
			case "ground_50n":
				...
				break;
			case "ground_50w":
				Player.setPosition("ground_50s");
				break;
			case "ground_50s":
				Player.setPosition("ground_50e");
				break;
			case "ground_50e":
				Player.setPosition("ground_50n");
				break;
			case "ground_51n":
				Player.setPosition("ground_51w");
				break;
			case "ground_51w":
				Player.setPosition("ground_51s");
				break;
			case "ground_51s":
				Player.setPosition("ground_51e");
				break;
			case "ground_51e":
				Player.setPosition("ground_51n");
				break;
			case "ground_52n":
				Player.setPosition("ground_52w");
				break;
			case "ground_52w":
				Player.setPosition("ground_52s");
				break;
			case "ground_52s":
			...
			case "ground_53e":
				...
				break;
			case "ground_54n":
				Player.setPosition("ground_54w");
				break;
			case "ground_54w":
				Player.setPosition("ground_54s");
				break;
			case "ground_54s":
				Player.setPosition("ground_54e");
				break;
			case "ground_54e":
				Player.setPosition("ground_54n");
				break;
			case "ground_55n":
				Player.setPosition("ground_55w");
				break;
			case "ground_55w":
				Player.setPosition("ground_55s");
				break;
			case "ground_55s":
				Player.setPosition("ground_55e");
				break;
			case "ground_55e":
				Player.setPosition("ground_55n");
				break;
			case "ground_56n":
				Player.setPosition("ground_56w");
				break;
			case "ground_56w":
				Player.setPosition("ground_56s");
				break;
			case "ground_56s":
				Player.setPosition("ground_56e");
				break;
			case "ground_56e":
				Player.setPosition("ground_56n");
				break;
			case "ground_57n":
				Player.setPosition("ground_57w");
				break;
			case "ground_57w":
				Player.setPosition("ground_57s");
				break;
			case "ground_57s":
				Player.setPosition("ground_57e");
				break;
			case "ground_57e":
				Player.setPosition("ground_57n");
				break;
			case "ground_58n":
				Player.setPosition("ground_58w");
				break;
			case "ground_58w":
				Player.setPosition("ground_58s");
				break;
			case "ground_58s":
				Player.setPosition("ground_58e");
				break;
			case "ground_58e":
				Player.setPosition("ground_58n");
				break;
			case "ground_59n":
				Player.setPosition("ground_59w");
				break;
			case "ground_59w":
				Player.setPosition("ground_59s");
				break;
			case "ground_59s":
				Player.setPosition("ground_59e");
				break;
			case "ground_59e":
				Player.setPosition("ground_59n");
				break;
			case "ground_60n":
				Player.setPosition("ground_60w");
				break;
			case "ground_60w":
				Player.setPosition("ground_60s");
				break;
			case "ground_60s":
				Player.setPosition("ground_60e");
				break;
			case "ground_60e":
				Player.setPosition("ground_60n");
				break;
			case "ground_61n":
				Player.setPosition("ground_61w");
				break;
			case "ground_61w":
				Player.setPosition("ground_61s");
				break;
			case "ground_61s":
				Player.setPosition("ground_61e");
				break;
			case "ground_61e":
				Player.setPosition("ground_61n");
				break;
			case "ground_62n":
				Player.setPosition("ground_62w");
				break;
			case "ground_62w":
				Player.setPosition("ground_62s");
				break;
			case "ground_62s":
				Player.setPosition("ground_62e");
				break;
			case "ground_62e":
				Player.setPosition("ground_62n");
				break;
			case "ground_63n":
				Player.setPosition("ground_63w");
				break;
			case "ground_63w":
				Player.setPosition("ground_63s");
				break;
			case "ground_63s":
				Player.setPosition("ground_63e");
				break;
			case "ground_63e":
				Player.setPosition("ground_63n");
				break;
			case "ground_64n":
				Player.setPosition("ground_64w");
				break;
			case "ground_64w":
				Player.setPosition("ground_64s");
				break;
			case "ground_64s":
				Player.setPosition("ground_64e");
				break;
			case "ground_64e":
				Player.setPosition("ground_64n");
				break;
			case "ground_65n":
				Player.setPosition("ground_65w");
				break;
			case "ground_65w":
				Player.setPosition("ground_65s");
				break;
			case "ground_65s":
				Player.setPosition("ground_65e");
				break;
			case "ground_65e":
				Player.setPosition("ground_65n");
				break;
			case "ground_66n":
				Player.setPosition("ground_66w");
				break;
			case "ground_66w":
				Player.setPosition("ground_66s");
				break;
			case "ground_66s":
				Player.setPosition("ground_66e");
				break;
			case "ground_66e":
				Player.setPosition("ground_66n");
				break;
			case "ground_67n":
				Player.setPosition("ground_67w");
				break;
			case "ground_67w":
				Player.setPosition("ground_67s");
				break;
			case "ground_67s":
				Player.setPosition("ground_67e");
				break;
			case "ground_67e":
				Player.setPosition("ground_67n");
				break;
			case "ground_68n":
				Player.setPosition("ground_68w");
				break;
			case "ground_68w":
				Player.setPosition("ground_68s");
				break;
			case "ground_68s":
				Player.setPosition("ground_68e");
				break;
			case "ground_68e":
				Player.setPosition("ground_68n");
				break;
			case "ground_69n":
				Player.setPosition("ground_69w");
				break;
			case "ground_69w":
				Player.setPosition("ground_69s");
				break;
			case "ground_69s":
				Player.setPosition("ground_69e");
				break;
			case "ground_69e":
				Player.setPosition("ground_69n");
				break;
			case "ground_70n":
				Player.setPosition("ground_70w");
				break;
			case "ground_70w":
				Player.setPosition("ground_70s");
				break;
			case "ground_70s":
				Player.setPosition("ground_70e");
				break;
			case "ground_70e":
				Player.setPosition("ground_70n");
				break;
			case "ground_71n":
				Player.setPosition("ground_71w");
				break;
			case "ground_71w":
			...
			case "ground_71e":
				...
				break;
			case "ground_72n":
				Player.setPosition("ground_72w");
				break;
			case "ground_72w":
				Player.setPosition("ground_72s");
				break;
			case "ground_72s":
				Player.setPosition("ground_72e");
				break;
			case "ground_72e":
				Player.setPosition("ground_72n");
				break;
			case "ground_73n":
				Player.setPosition("ground_73w");
				break;
			case "ground_73w":
				Player.setPosition("ground_73s");
				break;
			case "ground_73s":
				Player.setPosition("ground_73e");
				break;
			case "ground_73e":
				Player.setPosition("ground_73n");
				break;
			case "ground_74n":
				Player.setPosition("ground_74w");
				break;
			case "ground_74w":
				Player.setPosition("ground_74s");
				break;
			case "ground_74s":
				Player.setPosition("ground_74e");
				break;
			case "ground_74e":
				Player.setPosition("ground_74n");
				break;
			case "ground_75n":
			...
			case "ground_76n":
				...
				break;
			case "ground_76w":
				Player.setPosition("ground_76s");
				break;
			case "ground_76s":
				Player.setPosition("ground_76e");
				break;
			case "ground_76e":
				Player.setPosition("ground_76n");
				break;
			case "ground_77n":
			...
			case "ground_77s":
				...
				break;
			case "ground_77e":
				Player.setPosition("ground_77n");
				break;
			case "ground_78n":
				Player.setPosition("ground_78w");
				break;
			case "ground_78w":
				Player.setPosition("ground_78s");
				break;
			case "ground_78s":
				Player.setPosition("ground_78e");
				break;
			case "ground_78e":
				Player.setPosition("ground_78n");
				break;
			case "ground_79n":
				Player.setPosition("ground_79w");
				break;
			case "ground_79w":
				Player.setPosition("ground_79s");
				break;
			case "ground_79s":
				Player.setPosition("ground_79e");
				break;
			case "ground_79e":
				Player.setPosition("ground_79n");
				break;
			case "ground_80n":
				Player.setPosition("ground_80w");
				break;
			case "ground_80ne":
				Player.setPosition("ground_80n");
				break;
			case "ground_80w":
			...
			case "ground_81w":
				...
				break;
			case "ground_81s":
				Player.setPosition("ground_81e");
				break;
			case "ground_81e":
				Player.setPosition("ground_81n");
				break;
			case "ground_82n":
				Player.setPosition("ground_82w");
				break;
			case "ground_82w":
				Player.setPosition("ground_82s");
				break;
			case "ground_82s":
				Player.setPosition("ground_82e");
				break;
			case "ground_82e":
				Player.setPosition("ground_82n");
				break;
			case "ground_83n":
				Player.setPosition("ground_83w");
				break;
			case "ground_83w":
			...
			case "ground_84n":
				...
				break;
			case "ground_84w":
				Player.setPosition("ground_84s");
				break;
			case "ground_84s":
				Player.setPosition("ground_84e");
				break;
			case "ground_84e":
				Player.setPosition("ground_84n");
				break;
			case "ground_85n":
				Player.setPosition("ground_85w");
				break;
			case "ground_85w":
				Player.setPosition("ground_85s");
				break;
			case "ground_85s":
				Player.setPosition("ground_85e");
				break;
			case "ground_85e":
				Player.setPosition("ground_85n");
				break;
			case "ground_86n":
				Player.setPosition("ground_86w");
				break;
			case "ground_86w":
				Player.setPosition("ground_86s");
				break;
			case "ground_86s":
				Player.setPosition("ground_86e");
				break;
			case "ground_86e":
				Player.setPosition("ground_86n");
				break;
			case "ground_87n":
				Player.setPosition("ground_87w");
				break;
			case "ground_87w":
				Player.setPosition("ground_87s");
				break;
			case "ground_87s":
				Player.setPosition("ground_87e");
				break;
			case "ground_87e":
				Player.setPosition("ground_87n");
				break;
			case "ground_88n":
				Player.setPosition("ground_88w");
				break;
			case "ground_88w":
				Player.setPosition("ground_88s");
				break;
			case "ground_88s":
				Player.setPosition("ground_88e");
				break;
			case "ground_88e":
				Player.setPosition("ground_88n");
				break;
			case "ground_89n":
				Player.setPosition("ground_89w");
				break;
			case "ground_89w":
				Player.setPosition("ground_89s");
				break;
			case "ground_89s":
				Player.setPosition("ground_89e");
				break;
			case "ground_89e":
				Player.setPosition("ground_89n");
				break;
			case "ground_90n":
				Player.setPosition("ground_90w");
				break;
			case "ground_90w":
				Player.setPosition("ground_90s");
				break;
			case "ground_90s":
				Player.setPosition("ground_90e");
				break;
			case "ground_90e":
			...
			case "ground_92n":
				...
				break;
			case "ground_92w":
				Player.setPosition("ground_92s");
				break;
			case "ground_92s":
				Player.setPosition("ground_92e");
				break;
			case "ground_92e":
				Player.setPosition("ground_92n");
				break;
			case "ground_93n":
				Player.setPosition("ground_93w");
				break;
			case "ground_93w":
				Player.setPosition("ground_93s");
				break;
			case "ground_93s":
				Player.setPosition("ground_93e");
				break;
			case "ground_93e":
				Player.setPosition("ground_93n");
				break;
			case "ground_94n":
				Player.setPosition("ground_94w");
				break;
			case "ground_94w":
				Player.setPosition("ground_94s");
				break;
			case "ground_94s":
			...
			case "ground_94e":
				...
				break;
			case "ground_95n":
				Player.setPosition("ground_95w");
				break;
			case "ground_95w":
				Player.setPosition("ground_95s");
				break;
			case "ground_95s":
				Player.setPosition("ground_95e");
				break;
			case "ground_95e":
				Player.setPosition("ground_95n");
				break;
			case "ground_96n":
				Player.setPosition("ground_96w");
				break;
			case "ground_96w":
				Player.setPosition("ground_96s");
				break;
			case "ground_96s":
				Player.setPosition("ground_96e");
				break;
			case "ground_96e":
				Player.setPosition("ground_96n");
				break;
			case "ground_97n":
				Player.setPosition("ground_97w");
				break;
			case "ground_97w":
				Player.setPosition("ground_97s");
				break;
			case "ground_97s":
				Player.setPosition("ground_97e");
				break;
			case "ground_97e":
				Player.setPosition("ground_97n");
				break;
			case "ground_98n":
				Player.setPosition("ground_98w");
				break;
			case "ground_98w":
				Player.setPosition("ground_98s");
				break;
			case "ground_98s":
				Player.setPosition("ground_98e");
				break;
			case "ground_98e":
				Player.setPosition("ground_98n");
				break;
			case "ground_99n":
				Player.setPosition("ground_99w");
				break;
			case "ground_99w":
				Player.setPosition("ground_99s");
				break;
			case "ground_99s":
				Player.setPosition("ground_99e");
				break;
			case "ground_99e":
				Player.setPosition("ground_99n");
				break;
			case "ground_100n":
				Player.setPosition("ground_100w");
				break;
			case "ground_100w":
				Player.setPosition("ground_100s");
				break;
			case "ground_100s":
				Player.setPosition("ground_100e");
				break;
			case "ground_100e":
				Player.setPosition("ground_100n");
				break;
			case "ground_101n":
				Player.setPosition("ground_101w");
				break;
			case "ground_101w":
				Player.setPosition("ground_101s");
				break;
			case "ground_101s":
				Player.setPosition("ground_101e");
				break;
			case "ground_101e":
				Player.setPosition("ground_101n");
				break;
			case "ground_102n":
				Player.setPosition("ground_102w");
				break;
			case "ground_102w":
				Player.setPosition("ground_102s");
				break;
			case "ground_102s":
			...
			case "ground_103n":
				...
				break;
			case "ground_103w":
				Player.setPosition("ground_103s");
				break;
			case "ground_103s":
				Player.setPosition("ground_103e");
				break;
			case "ground_103e":
				Player.setPosition("ground_103n");
				break;
			case "ground_104n":
				Player.setPosition("ground_104w");
				break;
			case "ground_104w":
				Player.setPosition("ground_104s");
				break;
			case "ground_104s":
				Player.setPosition("ground_104e");
				break;
			case "ground_104e":
				Player.setPosition("ground_104n");
				break;
			case "ground_105n":
				Player.setPosition("ground_105w");
				break;
			case "ground_105w":
			...
			case "ground_106n":
				...
				break;
			case "ground_106w":
				Player.setPosition("ground_106s");
				break;
			case "ground_106s":
				Player.setPosition("ground_106e");
				break;
			case "ground_106e":
				Player.setPosition("ground_106n");
				break;
			case "ground_107n":
				Player.setPosition("ground_107w");
				break;
			case "ground_107w":
				Player.setPosition("ground_107s");
				break;
			case "ground_107s":
				Player.setPosition("ground_107e");
				break;
			case "ground_107e":
				Player.setPosition("ground_107n");
				break;
			case "ground_108n":
				Player.setPosition("ground_108w");
				break;
			case "ground_108w":
				Player.setPosition("ground_108s");
				break;
			case "ground_108s":
				Player.setPosition("ground_108e");
				break;
			case "ground_108e":
				Player.setPosition("ground_108n");
				break;
			case "ground_109n":
				Player.setPosition("ground_109w");
				break;
			case "ground_109w":
				Player.setPosition("ground_109s");
				break;
			case "ground_109s":
				Player.setPosition("ground_109e");
				break;
			case "ground_109e":
				Player.setPosition("ground_109n");
				break;
			case "ground_110n":
				Player.setPosition("ground_110w");
				break;
			case "ground_110w":
				Player.setPosition("ground_110s");
				break;
			case "ground_110s":
				Player.setPosition("ground_110e");
				break;
			case "ground_110e":
				Player.setPosition("ground_110n");
				break;
			...
			case "tunnel_1n":
				...
				break;
			case "tunnel_1w":
				Player.setPosition("tunnel_1s");
				break;
			case "tunnel_1s":
				Player.setPosition("tunnel_1e");
				break;
			case "tunnel_1e":
				Player.setPosition("tunnel_1n");
				break;
			case "tunnel_2n":
				Player.setPosition("tunnel_2w");
				break;
			case "tunnel_2w":
				Player.setPosition("tunnel_2s");
				break;
			case "tunnel_2s":
				Player.setPosition("tunnel_2e");
				break;
			case "tunnel_2e":
				Player.setPosition("tunnel_2n");
				break;
			case "tunnel_3n":
				Player.setPosition("tunnel_3w");
				break;
			case "tunnel_3w":
				Player.setPosition("tunnel_3s");
				break;
			case "tunnel_3s":
				Player.setPosition("tunnel_3e");
				break;
			case "tunnel_3e":
				Player.setPosition("tunnel_3n");
				break;
			case "tunnel_4n":
				Player.setPosition("tunnel_4w");
				break;
			case "tunnel_4w":
				Player.setPosition("tunnel_4s");
				break;
			case "tunnel_4s":
				Player.setPosition("tunnel_4e");
				break;
			case "tunnel_4e":
				Player.setPosition("tunnel_4n");
				break;
			case "tunnel_5n":
				Player.setPosition("tunnel_5w");
				break;
			case "tunnel_5w":
				Player.setPosition("tunnel_5s");
				break;
			case "tunnel_5s":
				Player.setPosition("tunnel_5e");
				break;
			case "tunnel_5e":
				Player.setPosition("tunnel_5n");
				break;
			case "tunnel_6n":
				Player.setPosition("tunnel_6w");
				break;
			case "tunnel_6w":
				Player.setPosition("tunnel_6s");
				break;
			case "tunnel_6s":
				Player.setPosition("tunnel_6e");
				break;
			case "tunnel_6e":
				Player.setPosition("tunnel_6n");
				break;
			case "tunnel_7n":
				Player.setPosition("tunnel_7w");
				break;
			case "tunnel_7w":
				Player.setPosition("tunnel_7s");
				break;
			case "tunnel_7s":
				Player.setPosition("tunnel_7e");
				break;
			case "tunnel_7e":
				Player.setPosition("tunnel_7n");
				break;

				
			default:
				System.out.println("Walk.center error");
				break;
		}
	}
}