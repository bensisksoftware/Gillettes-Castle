...
public class PrintGetImage {
	...
	private static void print() {
		...
		try {
			File file = new File("print/getImage " + zone + ".txt");	
			...
			for (int i = 1; i <= totalPositions*4; i++) {
				...
				output.println("\t\t\tcase \"" + zone + "_" + currentPosition + direction + "\":\n\t\t\t\treturn " + zone + "_" + currentPosition + direction + ";");
